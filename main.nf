...
if (params.variant_caller == 'haplotype-caller') {
    ...
    include { jointCallDeepVariant } from './modules/deepvariant'
    ...
    include { mergeGVCFs } from './modules/strelka2'
} else {
...
workflow {
    ...
    happy(
        ...
        (params.genome_file) // Assuming this passes the fasta and fai
    )
